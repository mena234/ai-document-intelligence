...
[Back to the project overview](README.md) · [Live demo](https://ai-document.ramzy.tech/)
...
The original hosted deployment uses OpenRouter with `z-ai/glm-5.3-flash`. A fork needs its own server-side key. See `QA.md` for historical verification and limitations.
